package com.moutamid.qr.scanner.generator.utils;
...
public class QRCode extends AbstractQRCode {
     ...
     * Size override is done by calling  e.g.
     ...
     */
    public static QRCode from(net.glxn.qrgen.core.scheme.Schema schema) {
    ...
    /**
     * Returns a {@link Bitmap} without creating a {@link File} first.
     *
     * @return {@link Bitmap} of this QRCode
     */
