...
public class FacebookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!getPurchaseSharedPreference()) {
            ConsoliAds.Instance().ShowBanner(NativePlaceholderName.Activity1, FacebookActivity.this, mediatedBannerView);
    ...
    public void facebookGenerate(View view) {
        ...
        if (link.getText().toString().equals("")) {
            ...
            try {
                ...
                History urlHistory = new History(social.generateString(), "facebook");
                ...
                if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE) ==
                    ...
                    ActivityCompat.requestPermissions(FacebookActivity.this, new String[]{
    ...
    public void backFacebook(View view) {
        if (!getPurchaseSharedPreference()) {
            ConsoliAds.Instance().ShowInterstitial(NativePlaceholderName.Activity1, this);
        }
        finish();
